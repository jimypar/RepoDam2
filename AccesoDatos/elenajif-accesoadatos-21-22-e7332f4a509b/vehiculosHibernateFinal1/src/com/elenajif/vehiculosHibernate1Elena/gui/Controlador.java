    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch(comando){
            ...
            case "Alta":
                ...
                nuevoPropietario.setApellidos(vista.txtApellidosPropietario.getText());
                nuevoPropietario.setFechaNacimiento(Date.valueOf(vista.fechaNacimiento.getDate()));
        ...
        if(e.getValueIsAdjusting()){
            if(e.getSource() == vista.listCoches) {
                ...
                if (cocheSeleccion.getPropietario() != null) {
                    vista.txtNombrePropietario.setText(cocheSeleccion.getPropietario().toString());
                } else {
