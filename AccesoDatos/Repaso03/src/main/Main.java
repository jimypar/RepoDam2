...
public class Main {
	...
	public static void main(String[] args) {
		...
		banco.listarCuentas();
		System.out.println("4º Asignar titulares y listar");
		...
		banco.listarCuentas();
		System.out.println("");
		System.out.println("5º Buscar cuenta 11-1111-11");
		System.out.println(banco.buscarCuenta("11-1111-11"));
		System.out.println("");
		System.out.println("6º Listar cuentas de un titular");
		banco.listarCuentasTitular("1111111");
		System.out.println("");
		System.out.println("7º Eliminar cuenta 11-1111-11 y listamos");
		banco.eliminarCuenta("11-1111-11");
		banco.listarCuentas();

		System.out.println("");
		System.out.println("8º Creamos una cuenta plan pensiones,asignamos titular");
		banco.altaCuentaPlanPesiones("44-4444-44", 321, 0.15, 0.35);
		banco.asignarCuentaCliente("1111111", "44-4444-44");
		banco.listarCuentas();
		System.out.println("");
		System.out.println("9º Creamos cuenta de ahorro fija, asignamos titular y listamos");
		banco.altaCuentaAhorro("55-5555-55", 354, 0.15);
		banco.asignarCuentaCliente("1111111", "55-5555-55");
		banco.listarCuentas();
		System.out.println("");
		System.out.println("10º Crear cuenta corriente asignamos titular y listamos");
		banco.altaCuentaCorriente("66-6666-66", 475, 0.3);
		banco.asignarCuentaCliente("2222222", "66-6666-66");
		banco.listarCuentas();
		System.out.println("");
		System.out.println("11º Ingreso en cuenta y listar");
		banco.ingreso(banco.buscarCuenta("33-3333-33"), 225);
		banco.listarCuentas();
		System.out.println("");
		System.out.println("12º reintegro de una cuenta corriente y listamos");
		banco.reintegro((CuentaCorriente) banco.buscarCuenta("66-6666-66"), 120);
		banco.listarCuentas();
		System.out.println("");
		System.out.println("13º Ingreso mes en una cuenta ahorro fija y listar");
