...
/**
 *
 * Clase que seencarga de fifrar texto utilizando el algoritmo RSA
 *
 */
public class RSA {
     ...
     *
     * @param plain String que representa el texto que se desea cifrar mediante RSA
     * @return String que representa el texto cifrado mediante algoritmo RSA
     *
     * @throws NoSuchAlgorithmException
     * @throws NoSuchPaddingException
     * @throws InvalidKeyException
    ...
    /**
     * Método que se encarga de desencriptar un texto cifrado mediante RSA
     *
