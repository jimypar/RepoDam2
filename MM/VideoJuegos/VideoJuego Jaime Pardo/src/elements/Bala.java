...
public class Bala extends Element{
	...
	public void dispararR() {
		...
		this.setPosition(Parametros.playerX, Parametros.playerY+60);
	...
	public void dispararUPR() {
		...
		this.setPosition(Parametros.playerX+70, Parametros.playerY);
	...
	public void dispararRDOWN() {
		this.setEnabled(true);
		this.setAnimation(derecha);
		this.setPosition(Parametros.playerX, Parametros.playerY+30);
		this.getVelocity().set(velocidadBala,0);		
	}
